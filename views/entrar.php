...
<div class="grid">
	<?= isset($_SESSION['erros']) ? retornaErros($_SESSION['erros']) : '';?>	
    <form action="/entrar" method="POST" class="form login">
    ...
    <p class="text--center">Não tem uma conta? <a href="/registrar">Registre-se agora!</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
