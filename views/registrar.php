...
<div class="grid">
    ...
    <form action="/registrar" method="POST" class="form login">

      <div class="form__field">
        <label for="login__name"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Nome</span></label>
        <input id="login__name" type="text" name="nome" class="form__input" placeholder="Nome" required>
      </div>
